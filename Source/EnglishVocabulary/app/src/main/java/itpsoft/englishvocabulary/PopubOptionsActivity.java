...
public class PopubOptionsActivity extends Activity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public static TextView tvChoosedTopic, tvChoosedNotifications, tvChoosedNumberVoca;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popup_options);
        init();
    }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        if (isChecked) {
            Toast.makeText(PopubOptionsActivity.this, isChecked + "", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(PopubOptionsActivity.this, "" + isChecked, Toast.LENGTH_SHORT).show();
        }
    }
